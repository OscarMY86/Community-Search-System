#This program is the online approach for k-truss community search
#The input files should be contain in a folder including:
#1.graph file: graph.txt
#2.querynode file: truss_querynode.txt |format each line: querynode k |example: 201 5
...
g++ -std=c++11 src/main.cpp -o ktcom
